...
% In a real system, the UGV would replan from its current position
% along the path. We replan from start to keep the comparison clean.
% A future improvement is D* Lite incremental replanning, which
% repairs only affected nodes (Koenig & Likhachev, 2002).
